...
namespace HexasphereGrid {
	...
	partial class Hexasphere : MonoBehaviour {
		...
		[SerializeField]
		bool 
		_reverseDragDirection = false;
		public bool reverseDragDirection {
			get {return _reverseDragDirection; }
			set {
				if (value != _reverseDragDirection) {
					_reverseDragDirection = value;
				}
			}
		}
		...
		[SerializeField]
		bool _rightClickRotatingClockwise = false;
