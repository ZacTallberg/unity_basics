...
namespace HexasphereGrid {
	...
	public class HexasphereEditor : Editor {
		...
		int tileHighlightedIndex = -1, tileTerritoryIndex, tileTextureIndex;
		...
		SerializedProperty style, numDivisions, smartEdges, transparent, transparencyTiles, transparencyCull, invertedMode, extruded, extrudeMultiplier, gradientIntensity, raycast3D, wireframeColor, wireframeColorFromTile, wireframeIntensity;
		SerializedProperty defaultShadedColor, tileTintColor, receiveShadows, tileTextureSize, rotationShift, vrEnabled;
		SerializedProperty lighting, ambientColor;
		...
		SerializedProperty rightClickRotates, rightClickRotatingClockwise, rightButtonDrag;
		SerializedProperty reverseDragDirection;
		SerializedProperty enableGridEditor;
		...
		void OnEnable () {
			...
			reverseDragDirection = serializedObject.FindProperty ("_reverseDragDirection");
